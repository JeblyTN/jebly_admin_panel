    ...
    public function payWithStripe($data){
        ...
        if(!empty($data['user']['withdrawMethod']['stripe']['accountId'])){
            ...
            try {
                ...
                if (!empty($response->id) && !empty($response->balance_transaction)) {
                    $payout_response = [
                        'success' => true,
                        'message' => 'We successfully processed your payout request',
                        'result' => [
                    ...
                    $payout_response = [
                        'success' => false,
                        'message' => "Transfer failed or account not valid: '{$accountId}'",
                        'status' => 'Failed'
                    ];
                }
