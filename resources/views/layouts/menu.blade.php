...
<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        @endif
        @if (in_array('drivers', $role_has_permission) || in_array('approve_drivers', $role_has_permission) || in_array('pending_drivers', $role_has_permission) || in_array('restaurants', $role_has_permission) || in_array('employee', $role_has_permission))
        ...
        @if (in_array('reports', $role_has_permission))
            ...
            <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                ...
                <ul aria-expanded="false" class="collapse">
                    ...
                    <li><a href="{!! url('/report/tax') !!}">{{ trans('lang.reports_tax') }}</a></li>
                </ul>
            </li>
        @endif
        ...
        @if (in_array('bulk_import_products', $role_has_permission))
            <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                    ...
                    <span class="hide-menu">{{ trans('lang.bulk_import_plural') }}</span>
                </a>
                <ul aria-expanded="false" class="collapse">
                    @if (in_array('bulk_import_products', $role_has_permission))
                        <li><a href="{!! route('bulk_import_products') !!}">{{ trans('lang.bulk_import_products_plural') }}</a></li>
                    @endif
                </ul>
            </li>
        @endif
        ...
        @if (in_array('global-setting', $role_has_permission) ||
                ...
                in_array('scheduleOrderNotification', $role_has_permission) || in_array('maintenance', $role_has_permission))
            ...
            <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                ...
                <ul aria-expanded="false" class="collapse">
                    ...
                    @endif
                    @if (in_array('maintenance', $role_has_permission))
                        <li><a href="{{ route('settings.maintenance') }}">{{ trans('lang.maintenance_mode') }}</a></li>
                    @endif
