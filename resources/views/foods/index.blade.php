            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card border">
                        ...
                        <div class="card-body">
                            <div class="table-responsive m-t-10 table--responsive">
...
<script type="text/javascript">
    ...
    async function buildHTML(val) {
        ...
        if(val.photos!=''&&val.photos!=null) {
           imageHtml='<div class="any"><img onerror="this.onerror=null;this.src=\''+placeholderImage+'\'" class="rounded" width="100%" style="width:70px;height:70px;" src="'+val.photo+'" alt="image"></div>';
        } else if(val.photo!=''&&val.photos!=null) {
           imageHtml='<div class="any"><img onerror="this.onerror=null;this.src=\''+placeholderImage+'\'" class="rounded" width="100%" style="width:70px;height:70px;" src="'+val.photo+'" alt="image"></div>';
        } else {
            imageHtml='<div class="any"><img width="100%" style="width:70px;height:70px;" src="'+placeholderImage+'" alt="image"></div>';
        }
      ...
      const tax = val.taxSetting || [];
        ...
        if (globalTaxScope === "product" && tax.length > 0) {
            ...
            tax_titles = `<span class="d-block text-muted">Taxes: ${taxDisplay}</span>`;
        }
        html.push(imageHtml+'<div class="any"><a href="'+route1+'" >'+val.name+'</a>'+tax_titles+'</div>');
    ...
    $('#select-all').change(function() {
        ...
        $('input[type="checkbox"][name="record"]').prop('checked',isChecked).trigger('change');
    });
