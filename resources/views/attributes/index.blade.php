                    ...
                    <div class="d-flex top-title-right align-self-center">
                        <div class="select-box pl-3">
                            <select class="form-control restaurant_type_selector d-none">
                                <option value="">{{trans('lang.sample_selection')}}</option>
                                <option value="true">{{trans('lang.sample')}}</option>
                            </select>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card card-box-with-icon">
                                    <div class="card-body d-flex justify-content-between align-items-center">
                                       <div class="card-box-with-content">
                                        ...
                                        <p class="mb-0 small text-dark-2">{{trans('lang.sample_block')}}</p>
                                       </div>
...
<script type="text/javascript">
    ...
    function buildHTML(val) {
        ...
        var actionHtml = '';
        actionHtml = actionHtml + '<span class="action-btn"><a href="' + route1 + '"><i class="mdi mdi-lead-pencil" title="{{trans('lang.edit')}}"></i></a>';
