                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="restaurants-list" value="restaurants" name="restaurants[]" class="permission" {{ in_array('restaurants', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="restaurants-list">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="restaurants-create" value="restaurants.create" name="restaurants[]" class="permission" {{ in_array('restaurants.create', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="restaurants-create">{{ trans('lang.create') }}</label>
                                                        <input type="checkbox" id="restaurants-edit" value="restaurants.edit" name="restaurants[]" class="permission" {{ in_array('restaurants.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="restaurants-edit">{{ trans('lang.edit') }}</label>
                                                        <input type="checkbox" id="restaurants-view" value="restaurants.view" name="restaurants[]" class="permission" {{ in_array('restaurants.view', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="restaurants-view">{{ trans('lang.view') }}</label>
                                                        <input type="checkbox" id="restaurant-delete" value="restaurant.delete" name="restaurant[]" class="permission" {{ in_array('restaurant.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="foods-list" value="foods" name="foods[]" class="permission" {{ in_array('foods', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="foods-list">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="foods-create" value="foods.create" name="foods[]" class="permission" {{ in_array('foods.create', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="foods-create">{{ trans('lang.create') }}</label>
                                                        <input type="checkbox" id="foods-edit" value="foods.edit" name="foods[]" class="permission" {{ in_array('foods.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="foods-edit">{{ trans('lang.edit') }}</label>
                                                        <input type="checkbox" id="foods-delete" value="foods.delete" name="foods[]" class="permission" {{ in_array('foods.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="pos-view" value="pos.view" name="pos[]" class="permission" {{in_array('pos.view',$permissions)
                                                                ? "checked" : "" }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="dinein-list" value="restaurants.booktable" name="dinein-orders[]" class="permission" {{ in_array('restaurants.booktable', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="dinein-list">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="dinein-edit" value="booktable.edit" name="dinein-orders[]" class="permission" {{ in_array('booktable.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="dinein-edit">{{ trans('lang.edit') }}</label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="restaurant-payouts-list" value="restaurantsPayouts" name="restaurant-payouts[]" class="permission" {{ in_array('restaurantsPayouts', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="restaurant-payouts-list">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="restaurant-payouts-create" value="restaurantsPayouts.create" name="restaurant-payouts[]" class="permission" {{ in_array('restaurantsPayouts.create', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="payout-request-restaurant" value="payoutRequests.restaurants" name="payout-request[]" class="permission" {{ in_array('payoutRequests.restaurants', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="payout-request-restaurant">{{ trans('lang.restaurant') }}
                                                            {{ trans('lang.list') }}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <strong>{{ trans('lang.maintenance_mode') }}</strong>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" id="maintenance" value="settings.maintenance" name="maintenance[]" class="permission" {{ in_array('settings.maintenance', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="maintenance">{{ trans('lang.update') }}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="dinein" value="settings.app.bookTable" name="dinein[]" class="permission" {{ in_array('settings.app.bookTable', $permissions) ? 'checked' : '' }}>
                                                        <label class="contol-label2" for="dinein">{{ trans('lang.update') }}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
