                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="maintenance" value="settings.maintenance" name="maintenance[]" class="permission">
                                                            <label class=" control-label2" for="maintenance">{{ trans('lang.update') }}</label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
