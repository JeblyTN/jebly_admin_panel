                        ...
                        <ul style="list-style: none;padding:0">
                            <li>
                                <a id="select-button" href="javascript:void(0)"
                                    ...
                                    title="{{trans('lang.use_this_tool_to_drag_the_map_and_select_your_desired_location')}}">
                            ...
                            <li>
                                <a id="add-button" href="javascript:void(0)"
                                    class="btn-floating zone-add-btn btn-large waves-effect waves-light tooltipped"
                                    title="{{trans('lang.use_this_tool_to_highlight_areas_and_connect_the_dots')}}">
                            ...
                            <li>
                                <a id="delete-all-button" href="javascript:void(0)" 
                                    ...
                                    title="{{trans('lang.use_this_tool_to_delete_all_selected_areas')}}">
        ...
        ref.get().then(async function (snapshots) {
            if (snapshots.docs) {
                ...
                for (let i = 0; i < values.length; i += 2) {
                    const lat = parseFloat(values[i]); // Latitude is the second value in the pair
                    const lon = parseFloat(values[i + 1]);    // Longitude is the first value in the pair
