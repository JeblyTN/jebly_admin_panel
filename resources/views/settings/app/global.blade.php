    ...
    <div class="page-wrapper">
        ...
        <div class="card-body">
            ...
            <div class="row restaurant_payout_create">
                <div class="restaurant_payout_create-inner page-inn">
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50">
                           <label class="col-5 control-label">{{trans('lang.default_country')}}</label>
                            <div class="col-7">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50" id="platform_fee_div" style="display:none;">
                            ...
                            <div class="col-7">
                                <input type="number" class="form-control" id="platform_fee" value="30" min="0">
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-100">
                            <div class="form-check width-100">
                                ...
                                <label class="col-5 control-label" for="emaployee_detail_management">{{ trans('lang.emaployee_detail_management') }}</label>
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        var refadminSettings = database.collection('settings').doc("adminSettings");
        ...
        $(document).ready(function() {
            ...
            ref.get().then(async function(snapshots) {
                ...
                if (globalSettings.order_ringtone_url != '' && globalSettings.order_ringtone_url != null) {
                    ...
                    var html = '<div class="col-md-3">\n' +
                        ...
                        '    {{trans("lang.your_browser_does_not_support_the_audio_element")}}\n' +
                        '  </audio>\n' +
                        '</div>\n' +
                        '</div>';
                ...
                if (globalSettings.defaultCountryCode) {
                    // Now defaultCountryCode is the ISO2 code like "US"
                    $('.defaultCountryCode').val(globalSettings.defaultCountryCode).trigger('change');

                    // Optional: fallback if not found (in case old data used phonecode)
                    if ($('.defaultCountryCode').val() == null) {
                        // Try fallback by phonecode (for backward compatibility)
                        var selectedCountry = $('.defaultCountryCode option').filter(function() {
                            return $(this).data('code') ===   globalSettings.defaultCountryCode;
                        }).first().val();
                        if (selectedCountry) {
            ...
            restaurant.get().then(async function(snapshots) {
                ...
                if (restaurantdata.isEmployeeManagement) {
            ...
            refadminSettings.get().then(async function(snapshots) {
                var admin_settings = snapshots.data();
                if (admin_settings.enable) {
                    $("#enable_platform_fee").prop('checked', true);
                    $("#platform_fee_div").show();
                }
                $("#platform_fee").val(admin_settings.amount);
            });
        ...
        $(".edit-setting-btn").click(function() {
            ...
            var $selectedOption = $('.defaultCountryCode option:selected');
            var defaultCountryCode = $selectedOption.length > 0 ? $selectedOption.data('code') : '';
            ...
            if (applicationName == '') {
                ...
                storeImageData().then(IMG => {
                    storeRingtone().then(ringtone => {
                        ...
                        database.collection('settings').doc("adminSettings").update({
                            'enable': enable_platform_fee,
                            'amount': (enable_platform_fee && platform_fee) ? platform_fee : '0',
                        });
