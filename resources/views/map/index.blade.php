                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="table-responsive ride-list">
                            <input type="text" id="searchInput" oninput="searchDriver()" placeholder="{{trans('lang.search_driver')}}">
                    ...
                    if (val.flag == "in_transit") {
                        ...
                        if (user != undefined && user != '') {
                            ...
                            if (val.author.shippingAddress && val.vendor.location) {
                                ...
                                destination = val.author.shippingAddress[0].locality;
                               
                                html += '<div class="to-ride"><span>' + destination + '</span></div>';
                                html += '</div>';
                            }
                            html += '<span class="badge badge-danger">{{trans("lang.in_tranist")}}</span>';
