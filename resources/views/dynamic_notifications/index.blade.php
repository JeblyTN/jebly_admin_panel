...
<script type="text/javascript">
    ...
    function buildHTML(val) {
        ...
        html.push('<span class="action-btn"><i class="text-dark fs-12 fa-solid fa fa-info" data-toggle="tooltip" title="' + title + '" aria-describedby="tippy-3"></i><a href="' + route1 + '"><i class="mdi mdi-lead-pencil" title="{{trans('lang.edit')}}"></i></a></span>');
        return html;
    }
