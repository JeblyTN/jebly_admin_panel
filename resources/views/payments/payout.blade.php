    ...
    <div class="card-body">
      <div class="menu-tab">
      		<ul>
      			...
      			<li>
      					<a href="{{route('restaurants.promos',$id)}}">{{trans('lang.tab_promos')}}</a>
      			</li>
      			<li class="active">
      					<a href="#">Payouts</a>
      			</li>
            ...
            <div class="col-lg-4 col-md-6">
                  <div class="card">
                      <div class="flex-row">
                          ...
                          <div class="align-self-center pt-3 col-md-12 text-center">
                              <h3 class="m-b-0 text-info" id="restaurant_count">44</h3>
                              <h5 class="text-muted m-b-0">{{trans('lang.total_payments')}}</h5>
                          </div>
                      </div>
                  </div>
            </div>
            <div class="col-lg-4 col-md-6">
                  <div class="card">
                      <div class="flex-row">
                          ...
                          <div class="align-self-center pt-3 col-md-12 text-center">
                              <h3 class="m-b-0 text-info" id="restaurant_count">44</h3>
                              <h5 class="text-muted m-b-0">{{trans('lang.remaining_payments')}}</h5>
                          </div>
                      </div>
                  </div>
            </div>
