...
Route::prefix('settings')->group(function () {
    ...
    Route::middleware(['permission:maintenance,settings.maintenance'])->group(function () {
        Route::get('app/maintenance', [App\Http\Controllers\SettingsController::class, 'maintenance'])->name('settings.maintenance');
    });
